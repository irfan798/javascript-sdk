...
Object.keys(_abciResponse).forEach(function (key) {
  ...
  if (key in exports && exports[key] === _abciResponse[key]) return;
...
Object.keys(_stdTx).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (key in exports && exports[key] === _stdTx[key]) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function get() {
      return _stdTx[key];
...
Object.keys(_txResult).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (key in exports && exports[key] === _txResult[key]) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function get() {
