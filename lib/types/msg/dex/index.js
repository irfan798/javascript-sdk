...
Object.keys(_cancelOrder).forEach(function (key) {
  ...
  if (key in exports && exports[key] === _cancelOrder[key]) return;
...
Object.keys(_newOrder).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (key in exports && exports[key] === _newOrder[key]) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function get() {
...
Object.keys(_listMiniMsg).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (key in exports && exports[key] === _listMiniMsg[key]) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function get() {
